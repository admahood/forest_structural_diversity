...
wd = "/Users/ealarue/Documents/data/invasion_metrics/plot_level_lidar/"
setwd(wd)
  ...
  
{
  ...
  #Probably its ok but if a site is near sea level would remove real points
...
#Liz stopped running here because didn't have other data
